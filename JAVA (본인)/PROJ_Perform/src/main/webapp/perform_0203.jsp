...
<style>
 /* 기본 세팅 */
   body {
    ...
    margin: 0; padding: 0; box-sizing: border-box; font-family: 'Apple SD Gothic Neo'; list-style: none;
    height: 900px;
        ...
        <option>월간</option> -->
            ...
            <!-- <li>실적 확인표</li> -->
                ...
                <!-- <button id="join">등록</button> -->
                    ...
                    <div id="cal">
                    <input type="date" id="date" value="yyyy-mm-dd" name="날짜선택">
                    <input type="week" id="weeks" value="yyyy-mm-dd"  name="날짜선택">
                    <input type="month" id="months" value="yyyy-mm-dd"  name="날짜선택">
                    </div>  

                        <div id="set">
                        <input type="text" id="text">
                        <button id="sele">조회</button>
                        </div>
