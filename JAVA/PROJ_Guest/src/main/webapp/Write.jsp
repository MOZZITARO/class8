...
<body>
    <div class="box">
        ...
        <form method="post" action="board" enctype="multipart/form-data" accept-charset="utf-8">
       
	        <div class="post">
	            <label for="title">제목</label>
	            <input type="text" id="title" name="write" />
	        </div>
	        ...
	        <div class="post">
	            ...
	            <textarea id="content" rows="5"  name="main"></textarea>
